!(function (t) {
    ...
    var o = function (t, e) {
        function o(e) {
            ...
            r && this.stack && (this.stack = n(this.stack, t, e)),
                (this.message = e || ""),
                (this.name = t);
        }
        return (
            (o.prototype = new (e || Error)()),
    ...
    (i.prototype.toArray = function () {
                ...
                if (r + e > n) {
                    for (var o = 0; o < e; ++o) {
                        this._checkCapacity(r + 1),
                            (this[
                                (i = (this._front + r) & (this._capacity - 1))
                            ] = arguments[o]),
                            r++,
                            (this._length = r);
                    }
        ...
        (i.prototype.unshift = function (t) {
            ...
            if (r > 1) {
                ...
                for (n = r - 1; n >= 0; n--) {
                    var s;
                    (this[(s = (((i - 1) & (o - 1)) ^ o) - o)] = arguments[n]),
                        (i = s);
                }
        ...
        (i.prototype._resizeTo = function (t) {
            ...
            r + n > e &&
                (function (t, e, r, n, o) {
                    for (var i = 0; i < o; ++i)
                        (r[i + n] = t[i + e]), (t[i + e] = void 0);
                })(this, 0, this, e, (r + n) & (e - 1));
        });
    var s = Array.isArray;
    function a(t) {
        if ("number" != typeof t) {
        ...
        return (
            (e = Math.min(Math.max(16, t), 1073741824)),
            (e >>>= 0),
            (e -= 1),
            (e |= e >> 1),
            (e |= e >> 2),
    ...
    var c = i,
        l = function () {
            for (var t = {}, e = 0; e < arguments.length; e++) {
                var r = arguments[e];
                for (var n in r) u.call(r, n) && (t[n] = r[n]);
            }
            return t;
        },
        ...
        E = (function () {
            function t(e) {
                !(function (t, e) {
                    ...
                    (this.bufferSize = e.bufferSize || 256),
                    (this.handlers = e.handlers),
                    (this.helpfulStacks = !!e.helpfulStacks),
                    (this.hostHandlers = e.hostHandlers),
                    (this.local = e.local),
                    (this.noisy = "boolean" != typeof e.noisy || e.noisy),
                    (this.Promise = e.Promise || window.Promise),
                    (this.remote = e.remote),
                    (this.secret = e.secret),
                    (this.Sentry = e.Sentry),
                    (this.strict = !!e.strict),
                    (this.targetOrigin = e.targetOrigin),
                    (this._seed = t.randomId(16)),
                    (this._ctr = 0),
                    (this._pendingRequests = {}),
                    (this._messageQueues = new Map());
                try {
                    this._messageQueues.set(
                        this.remote,
                        new _(this.bufferSize)
                    );
                } catch (t) {
            ...
            return (
                ...
                (n = [
                    {
                        ...
                        value: function (t) {
                            ...
                            if (window.crypto && window.crypto.getRandomValues)
                                ...
                                "object" === h(window.msCrypto) &&
                                "function" ==
                                    typeof window.msCrypto.getRandomValues
                            )
                                r = window.msCrypto.getRandomValues(
                                    new Uint32Array(e)
                                );
                            else
                                for (; r.length < e; )
                            ...
                            for (var n = [], o = 0; o < e; o += 1)
                                n.push(g[r[o] % g.length]);
                            return n.join("");
                        },
                    },
                    {
                ...
                (r = [
                        ...
                        value: function () {
                            ...
                            this.stop(),
                                (this.listener = function (e) {
                                    ...
                                    null != e.data &&
                                        ((r !== t.remote &&
                                            e.data.secret !== t.secret) ||
                                            t._handleMessage(e.data, r));
                                }),
                                this.local.addEventListener(
                                    "message",
                                    this.listener
                                );
                        },
                    },
                    {
                        key: "stop",
                        value: function () {
                            this.local.removeEventListener(
                                "message",
                                this.listener
                            );
                        },
                        ...
                        value: function (e, r, n, o) {
                            ...
                            this.Promise.try(function () {
                                if (
                                    ...
                                    throw new t.UnsupportedCommand(
                                        "unsupported command: ".concat(r)
                                    );
                                ...
                                .catch(function (t) {
                                    i.Sentry && t.code !== b
                                        ? i.Sentry.withScope(function (e) {
                                              if (
                                                  (e.setTag("command", r),
                                                  n && n[0] && n[0].context)
                                              ) {
                                                  var o = n[0].context;
                                                  e.setTag("idBoard", o.board),
                                                      "object" ===
                                                          h(o.permissions) &&
                                                          Object.keys(
                                                              o.permissions
                                        ...
                                        : i.noisy &&
                                          ...
                                          (console.warn(
                                              "Power-Up unhandled error responding to request for",
                                              r
                                          ),
                                          console.warn(t)),
                                        i.respond(
                    ...
                    },
                    {
                        ...
                        value: function (e, r, n) {
                            ...
                            if ((delete this._pendingRequests[e], r))
                                return o.resolve(n);
                            var i = ""
                                .concat(n.message || "", " (Command: ")
                                .concat(o.command, ")");
                            switch (n.code) {
                                case m:
                                    return o.reject(
                                ...
                                default:
                                    return o.reject(
                                        t.errorWithStack(Error, i, o.stack)
                                    );
                            }
                        },
                    },
                            ...
                            if ("bulk" === e) {
                                ...
                                if (this._targetsFallback)
                                    if (n === this.remote) s = "remote";
                                        ...
                                        s ||
                                            ((s = t.randomId(8)),
                                            (this._targetsFallback[s] = n));
                                    }
                                this._messageQueues.has(s) ||
                                    this._messageQueues.set(
                                        s,
                                        new _(this.bufferSize)
                                    );
                                var u = this._messageQueues.get(s);
                                u.isEmpty() &&
                                    setTimeout(function () {
                                        return o.emptyQueue(s);
                                    }, 0),
                                    u.push({ type: e, data: r });
                            }
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (!e.isEmpty()) {
                                ...
                                var n =
                                    "string" == typeof t
                                        ? this._targetsFallback[t]
                                        : t;
                                t !== this.remote &&
                                    "remote" !== t &&
                                    (this._messageQueues.delete(t),
                                    this._targetsFallback &&
                                        delete this._targetsFallback[t]),
                                    this.raw("bulk", r, n);
                            }
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            var s,
                                a = o[o.length - 1];
                            a &&
                                "function" == typeof a.postMessage &&
                                (s = o.pop());
                            var c = { args: o, command: t, id: r };
                            return (
                                this.helpfulStacks &&
                                    (c.stack = new Error().stack),
                                this.raw(
                                    "request",
                                    { args: o, command: t, id: r },
                                    s
                                ),
                                new this.Promise(function (t, n) {
                                    (c.resolve = t),
                                        (c.reject = n),
                                        (e._pendingRequests[r] = c);
                                })
                            );
                        },
                    },
    ...
    (E.PluginDisabled = y("PostMessageIO:PluginDisabled")),
        (E.PluginDisabled.prototype.code = m),
        (E.InvalidContext = y("PostMessageIO:InvalidContext")),
        (E.InvalidContext.prototype.code = w),
        (E.NotHandled = y("PostMessageIO:NotHandled")),
        (E.NotHandled.prototype.code = b),
        (E.UnsupportedCommand = y("PostMessageIO:UnsupportedCommand")),
        (E.UnsupportedCommand.prototype.code = k);
    var C,
        j,
        A,
        S = E,
    ...
    function T() {
        ...
        function a(t, r, n) {
            ...
            return e.defineProperty(t, r, o), t;
        }
        var c = (function () {
                ...
                return function (e) {
                    ...
                    var n = [];
                    t: for (var i in e)
                        if (o.call(e, i)) n.push(i);
                        else {
                            for (var s = 0; s < t.length; ++s)
                                if (o.call(t[s], i)) continue t;
                            n.push(i);
                        }
                    return n;
                };
        ...
        function p(t) {
            return t instanceof Error && e.propertyIsWritable(t, "stack");
        }
        var f =
            "stack" in new Error()
                ? function (t) {
                      return p(t) ? t : new Error(h(t));
                  }
                : function (t) {
                      if (p(t)) return t;
                      try {
        ...
        var y,
            _ = {
                isClass: function (t) {
                    try {
                        if ("function" == typeof t) {
                            var r = e.names(t.prototype),
                                n = e.isES5 && r.length > 1,
                                o =
                                    r.length > 0 &&
                                    !(1 === r.length && "constructor" === r[0]),
                                i = l.test(t + "") && e.names(t).length > 0;
                            if (n || o || i) return !0;
                        }
                        return !1;
                    } catch (t) {
                ...
                inheritedDataKeys: c,
                getDataPropertyOrDefault: function (t, r, n) {
                    if (!e.isES5)
                        return {}.hasOwnProperty.call(t, r) ? t[r] : void 0;
                ...
                classString: d,
                copyDescriptors: function (t, r, n) {
                    for (var o = e.names(t), i = 0; i < o.length; ++i) {
                        var s = o[i];
                        if (n(s))
                            try {
                                e.defineProperty(r, s, e.getDescriptor(t, s));
                            } catch (t) {}
                    }
                },
                hasDevTools:
                ...
                isNode:
                    ...
                    "[object process]" === d(process).toLowerCase(),
            };
        (_.isRecentNode =
            _.isNode &&
            ((0 === (y = process.versions.node.split(".").map(Number))[0] &&
                y[1] > 10) ||
                y[0] > 0)),
            _.isNode && _.toFastProperties(process);
        try {
            throw new Error();
        } catch (t) {
            _.lastLineError = t;
    ...
    function Qt() {
        ...
        var r = (function () {
            ...
            n = (function () {
                ...
                return (
                    (I = 1),
                    (t.prototype._willBeOverCapacity = function (t) {
                        return this._capacity < t;
                    }),
                    (t.prototype._pushOne = function (t) {
                        var e = this.length();
                        this._checkCapacity(e + 1),
                            (this[(this._front + e) & (this._capacity - 1)] =
                                t),
                            (this._length = e + 1);
                    }),
                    (t.prototype._unshiftOne = function (t) {
                        var e = this._capacity;
                    ...
                    (t.prototype.unshift = function (t, e, r) {
                        this._unshiftOne(r),
                            this._unshiftOne(e),
                            this._unshiftOne(t);
                    }),
                    ...
                    (t.prototype._checkCapacity = function (t) {
                        this._capacity < t &&
                            this._resizeTo(this._capacity << 1);
                    }),
                    (t.prototype._resizeTo = function (t) {
                        var e = this._capacity;
                        (this._capacity = t),
                            (function (t, e, r, n, o) {
                                for (var i = 0; i < o; ++i)
        ...
        function i() {
            (this._isTickUsed = !1),
                (this._lateQueue = new n(16)),
                (this._normalQueue = new n(16)),
                (this._trampolineEnabled = !0);
            var t = this;
            (this.drainQueues = function () {
                t._drainQueues();
            }),
                (this._schedule = r.isStatic ? r(this.drainQueues) : r);
        }
        function s(t, e, r) {
        ...
        return (
            ...
            o.hasDevTools
                ? (r.isStatic &&
                  ...
                  (i.prototype.invokeLater = function (t, e, r) {
                      this._trampolineEnabled
                          ? s.call(this, t, e, r)
                          : this._schedule(function () {
                                setTimeout(function () {
                ...
                : ((i.prototype.invokeLater = s),
                  (i.prototype.invoke = a),
                  (i.prototype.settlePromises = c)),
            (i.prototype.invokeFirst = function (t, e, r) {
    ...
    function Jt() {
        ...
        var t,
            ...
            o = T(),
            i = o.inherits,
            s = o.notEnumerableProp;
        function a(t, e) {
            function r(n) {
                if (!(this instanceof r)) return new r(n);
                s(this, "message", "string" == typeof n ? n : e),
                    s(this, "name", t),
        ...
        var c = a("Warning", "warning"),
            l = a("CancellationError", "cancellation error"),
            u = a("TimeoutError", "timeout error"),
            h = a("AggregateError", "aggregate error");
        try {
            (t = TypeError), (e = RangeError);
        } catch (r) {
            (t = a("TypeError", "type error")),
                (e = a("RangeError", "range error"));
        }
        for (
            var p =
            ...
            "function" == typeof Array.prototype[p[f]] &&
                (h.prototype[p[f]] = Array.prototype[p[f]]);
        ...
        function y(t) {
            ...
            s(this, "name", "OperationalError"),
                ...
                t instanceof Error
                    ? (s(this, "message", t.message), s(this, "stack", t.stack))
                    : Error.captureStackTrace &&
                      Error.captureStackTrace(this, this.constructor);
        }
        (h.prototype.toString = function () {
            var t = Array(4 * d + 1).join(" "),
                e = "\n" + t + "AggregateError of:\n";
            d++, (t = Array(4 * d + 1).join(" "));
        ...
        return (
            _ ||
                ...
                s(Error, "__BluebirdErrorTypes__", _)),
            (N = {
                Error: Error,
                TypeError: t,
                RangeError: e,
                  ...
                  r.inherits(a, Error),
                      ...
                      (a.prototype.attachExtraTrace = function (t) {
                          if (!t.__stackCleaned__) {
                              this.uncycle();
                              for (
                                  var e = a.parseStackAndMessage(t),
                                      n = e.message,
                                      o = [e.stack],
                                      i = this;
                                  void 0 !== i;
                      ...
                      (a.fireRejectionEvent = function (t, r, n, o) {
                          ...
                          s ||
                              ...
                              a.formatAndLogError(n, "Unhandled rejection ");
                      });
                  var u = function () {
                          return !1;
                      },
    ...
    function Yt() {
        ...
        Y = 1;
        var t = T(),
            e = t.maybeWrapAsError,
            r = Jt(),
            n = r.TimeoutError,
            o = r.OperationalError,
            i = t.haveGetters,
            s = O();
        var a,
        ...
        function l(e) {
            ...
            return t.markAsOriginatingFromRejection(e), e;
        }
        function u(t) {
            return function (r, n) {
                if (null !== t) {
        ...
        if (
            ...
            var h = {
                get: function () {
                    return u(this.promise);
                },
            };
            s.defineProperty(a.prototype, "asCallback", h),
                s.defineProperty(a.prototype, "callback", h);
        }
        return (
            (a._nodebackForPromise = u),
            (a.prototype.toString = function () {
                return "[object PromiseResolver]";
            }),
            (a.prototype.resolve = a.prototype.fulfill =
                function (t) {
              ...
              (lt = function (t) {
                  ...
                  (e.prototype.value = function () {
                      ...
                      (t.prototype.reason = function () {
                          ...
                          return (
                              t._unsetRejectionIsUnhandled(), t._settledValue
                          );
                      }),
                      ...
                      return (
                          (function a() {
                              ...
                              if (l instanceof t && l._isDisposable()) {
                                  ...
                                  if (l instanceof t)
                                      return l._then(a, c, null, null, null);
                              }
                              a();
                          })(),
                          s.promise
                  ...
                  (p.prototype.data = function () {
                      ...
                      (t.using = function () {
                          ...
                          2 === n && Array.isArray(arguments[0])
                              ? ((n = (o = arguments[0]).length), (s = !1))
                              : ((o = arguments), n--);
                          for (var c = new Array(n), l = 0; l < n; ++l) {
                              var f = o[l];
                              if (p.isDisposer(f)) {
                                  var y = f;
                                  (f = f.promise())._setDisposable(y);
                              } else {
                                  var _ = r(f);
                                  _ instanceof t &&
                                      (f = _._then(
                          ...
                          var v = t
                              ...
                              ._then(u, h, void 0, c, void 0);
                          return (c.promise = v), v;
                      }),
              ...
              (mt = function (t, e, r, n) {
                  ...
                  function l(e, n, o, i) {
                      (this._promise = new t(r))._captureStackTrace(),
                          ...
                          (this._yieldHandlers =
                              "function" == typeof o ? [o].concat(c) : c);
                  }
                  (l.prototype.promise = function () {
                      ...
                      (l.prototype._continue = function (e) {
                          ...
                          var r = e.value;
                          if (!0 === e.done) this._promise._resolveCallback(r);
                          else {
                      ...
                      (l.prototype._throw = function (t) {
                          this._promise._attachExtraTrace(t),
                              this._promise._pushContext();
                          var e = a(this._generator.throw).call(
                              this._generator,
                              t
                          );
                      ...
                      (l.prototype._next = function (t) {
                          this._promise._pushContext();
                          var e = a(this._generator.next).call(
                              this._generator,
                              t
                          );
                          this._promise._popContext(), this._continue(e);
              ...
              (St = function (t, e, r, n) {
                  ...
                  function i(s, a) {
                      ...
                      for (
                          ...
                          var d = s[p];
                          (void 0 !== d || p in s) &&
                              t.cast(d)._then(u, h, void 0, l, null);
                      }
                      return l;
                  }
                  (t.race = function (t) {
        ...
        return Bt
            ...
            : ((Bt = 1),
              (It = function (t, e) {
                  var r = {},
                      n = T(),
                      o = Yt()._nodebackForPromise,
                      i = n.withAppended,
                      s = n.maybeWrapAsError,
                      a = n.canEvaluate,
                      c = Jt().TypeError,
                  ...
                  function d(t, e, r) {
                      var o = n.getDataPropertyOrDefault(t, e + r, l);
                      return !!o && f(o);
                  }
                  function y(t, e, r, o) {
                      for (
                          var i = n.inheritedDataKeys(t), s = [], a = 0;
                          a < i.length;
                          ++a
                      ) {
                          var l = i[a],
                  ...
                  var _ = a
                      ? function (a, c, l, u) {
                            var h = Math.max(
                                ...
                                f = "string" == typeof a || c === r;
                            function d(t) {
                                var e,
                                    r = ((e = t),
                                    n.filledRange(e, "_arg", "")).join(", "),
                                    o = t > 0 ? ", " : "";
                                return (
                                    f
                      ...
                      : function (a, c, l, u) {
                            ...
                            function f() {
                                ...
                                var u =
                                        "string" == typeof p && this !== h
                                            ? this[p]
                                            : a,
                                    f = o(l);
                                try {
                                    u.apply(n, i(arguments, f));
                                } catch (t) {
                            ...
                            return (
                                "string" == typeof p && (a = u),
                                n.notEnumerableProp(f, "__isPromisified__", !0),
                                f
                            );
                        };
                  function v(t, e, o, i) {
                  ...
                  (t.promisify = function (t, e) {
                      ...
                      if (f(t)) return t;
                      var o = g(t, arguments.length < 2 ? r : e);
                      return n.copyDescriptors(t, o, p), o;
                  }),
                      (t.promisifyAll = function (t, e) {
                          ...
                          for (
                              var s = n.inheritedDataKeys(t), a = 0;
                              a < s.length;
                              ++a
                          ) {
                              var l = t[s[a]];
              ...
              (qt = function (t, e) {
                  var r = T(),
                      ...
                      i = (t.delay = function (r, n) {
                          ...
                          return (
                              (n = +n),
                              t.resolve(r)._then(o, null, null, n, void 0)
                          );
                      });
                  function s(t) {
                      var e = this;
                                  ...
                                  t.isPending() &&
                                      (!r.isPrimitive(e) && e instanceof Error
                                          ...
                                          : ("string" != typeof e &&
                                            ...
                                            (o = new n(e))),
                                      r.markAsOriginatingFromRejection(o),
    ...
    ((Wt = F).exports = function () {
        ...
        (t = o.isNode
            ...
            o.notEnumerableProp(k, "_getDomain", t);
        var i = {},
            s = Qt(),
            a = Jt(),
            c = (k.TypeError = a.TypeError);
        (k.RangeError = a.RangeError),
            (k.CancellationError = a.CancellationError),
            (k.TimeoutError = a.TimeoutError),
            (k.OperationalError = a.OperationalError),
            (k.RejectionError = a.OperationalError),
            (k.AggregateError = a.AggregateError);
        var l = function () {},
            u = {},
            h = { e: null },
            p = Gt()(k, l),
                ...
                L
                    ...
                    : ((L = 1),
                      (q = function (t, e, r, n) {
                          ...
                          function i(r) {
                              var n,
                                  o = (this._promise = new t(e));
                              r instanceof t &&
                                  ((n = r), o._propagateFrom(n, 5)),
                                  (this._values = r),
                                  (this._length = 0),
                          ...
                          return (
                              ...
                              (i.prototype._promiseProgressed = function (
                                  t,
                                  e
                              ) {
                ...
                V
                    ...
                    : ((V = 1),
                      (W = function (t, e) {
                          ...
                          return (
                              a.isNode &&
                                  0 == process.env.BLUEBIRD_DEBUG &&
                                  (l = !1),
                              l && i.disableTrampolineIfNecessary(),
                              ...
                              (t.prototype._notifyUnhandledRejection =
                                  function () {
                              ...
                              (t.prototype._isUnhandledRejectionNotified =
                                  function () {
                                      return (524288 & this._bitField) > 0;
                                  }),
                              (t.prototype._setRejectionIsUnhandled =
                                  function () {
                                      this._bitField = 2097152 | this._bitField;
                                  }),
                              (t.prototype._unsetRejectionIsUnhandled =
                                  function () {
                                      (this._bitField =
                              ...
                              (t.prototype._setCarriedStackTrace = function (
                                  t
                              ) {
                      ...
                      (K = function (t, e, r) {
                          ...
                          return (
                              ...
                              (t.prototype._pushContext =
                                  o.prototype._pushContext),
                              (t.prototype._popContext =
                                  o.prototype._popContext),
                              function () {
                                  if (r()) return new o();
                              }
                          );
                ...
                G
                    ...
                    : ((G = 1),
                      (J = function (t) {
                          ...
                          return (
                              (a.prototype.doFilter = function (e) {
                                  for (
                                      var r = this._callback,
                                          i = this._promise._boundValue(),
                                          s = 0,
        ...
        return (
            ...
            (k.prototype.caught = k.prototype.catch =
                function (t) {
                    var e = arguments.length;
                    if (e > 1) {
                        var r,
                        ...
                        n.length = o;
                        var s = new v(n, (t = arguments[r]), this);
                        return this._then(
                            void 0,
                            s.doFilter,
                            void 0,
            ...
            (k.prototype.then = function (t, e, r) {
                if (
                    ...
                    var n =
                        ...
                        o.classString(t);
                    arguments.length > 1 && (n += ", " + o.classString(e)),
                        this._warn(n);
                }
            ...
            (k.prototype.spread = function (t, e) {
                return this.all()._then(t, e, void 0, u, void 0);
            }),
            ...
            (k.getNewLibraryCopy = Wt.exports),
            (k.is = function (t) {
                return t instanceof k;
            }),
            (k.fromNode = function (t) {
                var e = new k(l),
                    r = b(t)(m(e));
            ...
            (k.cast = function (t) {
                ...
                if (!(e instanceof k)) {
                    var r = e;
                    (e = new k(l))._fulfillUnchecked(r);
                }
                return e;
            }),
            (k.resolve = k.fulfilled = k.cast),
            (k.reject = k.rejected =
                function (t) {
                    var e = new k(l);
                    return e._captureStackTrace(), e._rejectCallback(t, !0), e;
                }),
            (k.setScheduler = function (t) {
                if ("function" != typeof t)
                    throw new c(
                        "fn must be a function\n\n    See http://goo.gl/916lJJ\n"
                    );
            ...
            (k.prototype._then = function (e, r, n, o, i) {
                var a = void 0 !== i,
                    c = a ? i : new k(l);
                ...
                u !== this &&
                    ...
                    a || c._setIsMigrated());
                var h = u._addCallbacks(e, r, n, c, o, t());
                return (
                    u._isResolved() &&
                        !u._isSettlePromisesQueued() &&
                        s.invoke(u._settlePromiseAtPostResolution, u, h),
                    c
                );
            }),
            (k.prototype._settlePromiseAtPostResolution = function (t) {
            ...
            (k.prototype._cancellable = function () {
                return (67108864 & this._bitField) > 0;
            }),
            (k.prototype._setCancellable = function () {
                this._bitField = 67108864 | this._bitField;
            }),
            (k.prototype._unsetCancellable = function () {
                this._bitField = -67108865 & this._bitField;
            }),
            (k.prototype._setIsMigrated = function () {
                this._bitField = 4194304 | this._bitField;
            }),
            (k.prototype._unsetIsMigrated = function () {
                this._bitField = -4194305 & this._bitField;
            }),
            (k.prototype._isMigrated = function () {
                return (4194304 & this._bitField) > 0;
            }),
            (k.prototype._receiverAt = function (t) {
            ...
            (k.prototype._promiseAt = function (t) {
                return 0 === t ? this._promise0 : this[5 * t - 5 + 3];
            }),
            (k.prototype._fulfillmentHandlerAt = function (t) {
                return 0 === t
                    ? this._fulfillmentHandler0
                    : this[5 * t - 5 + 0];
            }),
            (k.prototype._rejectionHandlerAt = function (t) {
                return 0 === t ? this._rejectionHandler0 : this[5 * t - 5 + 1];
            }),
            (k.prototype._boundValue = function () {
                var t = this._boundTo;
                return void 0 !== t && t instanceof k
                    ? t.isFulfilled()
                        ? t.value()
                        : void 0
                    : t;
            }),
            (k.prototype._migrateCallbacks = function (t, e) {
                var r = t._fulfillmentHandlerAt(e),
                    n = t._rejectionHandlerAt(e),
                    o = t._progressHandlerAt(e),
                    s = t._promiseAt(e),
                    a = t._receiverAt(e);
                s instanceof k && s._setIsMigrated(),
                    void 0 === a && (a = i),
                    this._addCallbacks(r, n, o, s, a, null);
            }),
            (k.prototype._addCallbacks = function (t, e, r, n, o, i) {
                var s = this._length();
                if ((s >= 131066 && ((s = 0), this._setLength(0)), 0 === s))
                    ...
                    (this[a + 3] = n),
                        (this[a + 4] = o),
                        "function" == typeof t &&
                            (this[a + 0] = null === i ? t : i.bind(t)),
                        "function" == typeof e &&
                            (this[a + 1] = null === i ? e : i.bind(e)),
                        "function" == typeof r &&
                            (this[a + 2] = null === i ? r : i.bind(r));
                }
                return this._setLength(s + 1), s;
            }),
            (k.prototype._setProxyHandlers = function (t, e) {
                var r = this._length();
            ...
            (k.prototype._proxyPromiseArray = function (t, e) {
                this._setProxyHandlers(t, e);
            }),
            (k.prototype._resolveCallback = function (t, r) {
                if (!this._isFollowingOrFulfilledOrRejected()) {
                    if (t === this) return this._rejectCallback(e(), !1, !0);
                    var n = p(t, this);
                    if (!(n instanceof k)) return this._fulfill(t);
                    var o = 1 | (r ? 4 : 0);
                    this._propagateFrom(n, o);
                    var i = n._target();
                    if (i._isPending()) {
                        for (var s = this._length(), a = 0; a < s; ++a)
                            i._migrateCallbacks(this, a);
                        this._setFollowing(),
                            this._setLength(0),
                            this._setFollowee(i);
                    } else
            ...
            (k.prototype._rejectCallback = function (t, e, r) {
            ...
            (k.prototype._resolveFromResolver = function (t) {
                var e = this;
            ...
            (k.prototype._settlePromiseFromHandler = function (t, r, n, o) {
                var i;
                if (!o._isRejected())
                    if (
                        (o._pushContext(),
                        (i =
                            r !== u || this._isRejected()
                                ? b(t).call(r, n)
                                : b(t).apply(this._boundValue(), n)),
                        o._popContext(),
                        i === w || i === o || i === h)
                    ) {
                        var s = i === o ? e() : i.e;
            ...
            (k.prototype._settlePromiseAt = function (t) {
                ...
                this._clearCallbackDataAtIndex(t),
                    "function" == typeof n
                        ? r
                            ? this._settlePromiseFromHandler(n, a, i, e)
                            : n.call(a, i, e)
                        : a instanceof f
                        ? a._isResolved() ||
                          (this._isFulfilled()
                    ...
                    t >= 4 &&
                        4 == (31 & t) &&
                        s.invokeLater(this._setLength, this, 0);
            }),
            (k.prototype._clearCallbackDataAtIndex = function (t) {
                if (0 === t)
                    this._isCarryingStackTrace() ||
                        (this._fulfillmentHandler0 = void 0),
                        (this._rejectionHandler0 =
            ...
            (k.prototype._isSettlePromisesQueued = function () {
                return -1073741824 == (-1073741824 & this._bitField);
            }),
            (k.prototype._setSettlePromisesQueued = function () {
                this._bitField = -1073741824 | this._bitField;
            }),
            (k.prototype._unsetSettlePromisesQueued = function () {
                this._bitField = 1073741823 & this._bitField;
            }),
            (k.prototype._queueSettlePromises = function () {
                s.settlePromises(this), this._setSettlePromisesQueued();
            }),
            (k.prototype._fulfillUnchecked = function (t) {
                if (t === this) {
                    var r = e();
                    return (
                        this._attachExtraTrace(r),
                        this._rejectUnchecked(r, void 0)
                    );
                }
                this._setFulfilled(),
            ...
            (k.prototype._rejectUncheckedCheckError = function (t) {
                var e = o.ensureErrorObject(t);
                this._rejectUnchecked(t, e === t ? void 0 : e);
            }),
            (k.prototype._rejectUnchecked = function (t, r) {
                if (t === this) {
                    var n = e();
            ...
            o.notEnumerableProp(k, "_makeSelfResolutionError", e),
            (tt
                ? Z
                : ((tt = 1),
                  (Z = function (t, e) {
                      ...
                      (t.prototype.progressed = function (t) {
                          ...
                          (t.prototype._doProgressWith = function (e) {
                              ...
                              if (l === i) {
                                  if (
                                      null != l.e &&
                                      "StopProgressPropagation" !== l.e.name
                                  ) {
                                      var u = r.canAttachTrace(l.e)
                                          ? l.e
                                          : new Error(r.toString(l.e));
                                      a._attachExtraTrace(u), a._progress(l.e);
                                  }
                              } else
                                  l instanceof t
                                      ? l._then(
                  ...
                  (et = function (t, e, r, n) {
                      ...
                      (t.method = function (r) {
                          ...
                          return function () {
                              ...
                              return (
                                  n._popContext(), n._resolveFromSyncValue(o), n
                              );
                          };
                      }),
                          (t.attempt = t.try =
                  ...
                  (nt = function (t, e, r) {
                      ...
                      (t.prototype.bind = function (n) {
                          ...
                          if ((c._setBoundTo(a), a instanceof t)) {
                              ...
                              l._then(e, o, c._progress, c, u),
                                  a._then(i, s, c._progress, c, u);
                  ...
                  (it = function (t, e, r) {
                      ...
                      function c(t, e, r) {
                          ...
                          return (
                              (n = o(e)
                                  ...
                                  ? s
                                  : a),
                              t._then(n, i, void 0, e, void 0)
                          );
                      }
                      function l(n) {
                          var o = this.promise,
                              i = this.handler,
                              s = o._isBound() ? i.call(o._boundValue()) : i();
                          if (void 0 !== s) {
                              var a = r(s, o);
                              if (a instanceof t)
                                  return c(
                      ...
                      function u(e) {
                          var n = this.promise,
                              o = this.handler,
                              i = n._isBound()
                                  ? o.call(n._boundValue(), e)
                                  : o(e);
                          if (void 0 !== i) {
                              var s = r(i, n);
                              if (s instanceof t)
                                  return c((s = s._target()), e, !0);
                          }
                          return e;
                      }
                ...
                : ((pt = 1),
                  (ht = function (t, e, r, n) {
                      ...
                      if (i) {
                          ...
                          (f.prototype.callers = h),
                              (f.prototype.checkFulfillment = function (t) {
                                  var e = this.now;
                                  e++;
                                  var r = this.total;
                                  if (e >= r) {
                      ...
                      t.join = function () {
                          ...
                          if (
                              s > 0 &&
                              "function" == typeof arguments[s] &&
                              ((o = arguments[s]), s < 6 && i)
                          ) {
                              (v = new t(n))._captureStackTrace();
                              for (
                                  var a = new f(s, o), c = u, l = 0;
                                  l < s;
                                  ++l
                              ) {
                                  var h = r(arguments[l], v);
                                  h instanceof t
                                      ? (h = h._target())._isPending()
                                          ? h._then(c[l], d, void 0, v, a)
                                          : h._isFulfilled()
                                          ? c[l].call(v, h._value(), a)
                                          : v._reject(h._reason())
                                      : c[l].call(v, h, a);
                              }
                              return v;
                          ...
                          for (
                              ...
                              y[_] = arguments[_];
                          o && y.pop();
                          var v = new e(y).promise();
                          return void 0 !== o ? v.spread(o) : v;
                      };
                  })))(k, f, p, l),
            (k.version = "2.11.0"),
            (k.Promise = k),
                ...
                : ((dt = 1),
                  (ft = function (t, e, r, n, o) {
                      ...
                      function p(t, e, r, n) {
                          ...
                          var a = i();
                          (this._callback = null === a ? e : a.bind(e)),
                              (this._preservedValues =
                                  n === o ? new Array(this.length()) : null),
                              (this._limit = r),
                              (this._inFlight = 0),
                              (this._queue = r >= 1 ? [] : h),
                              s.invoke(f, this, void 0);
                      }
                      function f() {
                          this._init$(void 0, -2);
                      }
                      ...
                      a.inherits(p, e),
                          ...
                          (p.prototype._promiseFulfilled = function (e, r) {
                              var o = this._values,
                                  i = this.length(),
            ...
            (function () {
                ...
                return (Et = function (t) {
                    ...
                    function p(t) {
                        return h(t, this.pop()).apply(t, this);
                    }
                    function f(t) {
                        return t[this];
                    }
                    ...
                    (n = function (t) {
                        ...
                        (t.prototype.call = function (t) {
                            ...
                            return (
                                r.push(t),
                                this._then(p, void 0, void 0, r, void 0)
                            );
                        }),
                        (t.prototype.get = function (t) {
                            var e;
                            if ("number" == typeof t) e = d;
                            else if (s) {
                                var r = o(t);
                                e = null !== r ? r : f;
                            } else e = f;
                          ...
                          return i(s)
                              ? ((o =
                                    s instanceof t
                                        ...
                                        : new a(s).promise()),
                                s instanceof t && o._propagateFrom(s, 4),
                                o)
                              : n(
                  ...
                  (xt = function (t, e, r, n, o) {
                      ...
                      function u(e, r, a, c) {
                          this.constructor$(e),
                              ...
                              (this._zerothIsAccum = void 0 === a),
                              (this._gotAccum = !1),
                              (this._reducingIndex = this._zerothIsAccum
                                  ? 1
                                  : 0),
                              (this._valuesPhase = void 0);
                          var l = n(a, this._promise),
                              u = !1,
                              p = l instanceof t;
                          p &&
                              ((l = l._target())._isPending()
                                  ...
                                  : l._isFulfilled()
                                  ? ((a = l._value()), (this._gotAccum = !0))
                                  : (this._reject(l._reason()), (u = !0))),
                              p || this._zerothIsAccum || (this._gotAccum = !0);
                          var f = i();
                          (this._callback = null === f ? r : f.bind(r)),
                              (this._accum = a),
                              u || s.invoke(h, this, void 0);
                      }
                      function h() {
                          this._init$(void 0, -5);
                      }
                      ...
                      a.inherits(u, e),
                          ...
                          (u.prototype._promiseFulfilled = function (e, r) {
                              ...
                              if (!p)
                                  for (
                                      p = this._valuesPhase = new Array(s),
                                          i = 0;
                                      i < s;
                                      ++i
                                  )
                                  ...
                                  for (
                                      ...
                                      if (2 !== (i = p[_])) {
                                          ...
                                          if (
                                              ...
                                              return this._reject(f.e);
                                          var v = n(f, this._promise);
                                          if (v instanceof t) {
                                              if (
                                                  (v = v._target())._isPending()
                                              )
                                                  return (
                                                      (p[_] = 4),
                                                      v._proxyPromiseArray(
                                                          this,
                                                          _
                                                      )
                                                  );
            ...
            o.toFastProperties(k),
            o.toFastProperties(k.prototype),
            E({ a: 1 }),
            E({ b: 2 }),
            E({ c: 3 }),
            E(1),
            ...
            E(!1),
            E(new k(l)),
            d.setBounds(s.firstLineError, o.lastLineError),
            k
        );
    }),
        "undefined" != typeof Promise && (Vt = Promise);
    var ie = F.exports();
    ie.noConflict = function () {
        try {
            Promise === ie && (Promise = Vt);
        } catch (t) {}
        return ie;
    };
    var se = ie,
        ...
        le = (ae || ce || Function("return this")()).isFinite;
    var ue = function (t) {
    ...
    he.neutrals = he.shades;
    const pe = (t, e) => {
            if (!t || "string" != typeof t)
                throw new Error("Invalid color name");
            const r = t.toLowerCase();
            if (!he[r]) throw new Error("Unknown color name: " + r);
            const n = ue(e) ? e : 500;
            if (!he[r][n]) throw new Error("Unknown color weight: " + n);
            return he[r][n];
        },
        fe = (t) => {
            if (!t || "string" != typeof t)
            ...
            const e = /^([a-zA-Z-]+)(#[1-9]?0?0)?$/.exec(t);
            if (!e) throw new Error("Invalid accentColor provided");
            const r = e[1];
            let n = 500;
            return e[2] && (n = parseInt(e[2].substring(1), 10)), pe(r, n);
        };
    function de(t) {
        if (!t) return null;
        for (let e = 0; e < t.length; e += 1) {
            const r = t[e];
            if ("number" != typeof r || r % 1 != 0 || r > 255 || r < 0)
    ...
    function ye(t) {
        ...
        if (!/^[0-9a-f]+$/.test(e) || e.length % 2 != 0)
            throw new Error("Invalid hexString");
        const r = new Uint8Array(e.length / 2);
        for (let t = 0; t < e.length; t += 2) {
            const n = parseInt(e.substr(t, 2), 16);
            if (isNaN(n)) throw new Error("Invalid hexString");
            r[t / 2] = n;
        }
        return r;
    }
    ...
    function ke(t, e) {
        ...
        if ((t = void 0 !== t ? String(t).toLowerCase() : be) !== be)
    ...
    function Ee(t, e) {
        if (!(this instanceof Ee)) return new Ee(t, e);
        if ((t = void 0 !== t ? String(t).toLowerCase() : be) !== be)
            throw new Error("Encoding not supported. Only utf-8 is supported");
        (e = ve(e)),
            (this._streaming = !1),
    ...
    function Ce(t) {
        ...
        this.handler = function (t, a) {
            if (-1 === a && 0 !== o) return (o = 0), we(e);
            if (-1 === a) return me;
            if (0 === o) {
                if (_e(a, 0, 127)) return a;
                if (_e(a, 194, 223)) (o = 1), (r = a - 192);
                else if (_e(a, 224, 239))
                    224 === a && (i = 160),
                        237 === a && (s = 159),
                        (o = 2),
                        (r = a - 224);
                else {
                    if (!_e(a, 240, 244)) return we(e);
                    240 === a && (i = 144),
                        244 === a && (s = 143),
                        (o = 3),
                        (r = a - 240);
            ...
            if (!_e(a, i, s))
                return (
                    (r = o = n = 0), (i = 128), (s = 191), t.prepend(a), we(e)
                );
            if (
                ((i = 128),
                (s = 191),
    ...
    function je(t) {
        t.fatal,
            (this.handler = function (t, e) {
                if (-1 === e) return me;
                if (_e(e, 0, 127)) return e;
                var r, n;
                _e(e, 128, 2047)
                    ? ((r = 1), (n = 192))
                    : _e(e, 2048, 65535)
                    ? ((r = 2), (n = 224))
                    : _e(e, 65536, 1114111) && ((r = 3), (n = 240));
    ...
    (ke.prototype = {
        decode: function (t, e) {
            ...
            (r =
                ...
                (e = ve(e)),
                this._streaming ||
                    ((this._decoder = new Ce({ fatal: this._fatal })),
                    (this._BOMseen = !1)),
                (this._streaming = Boolean(e.stream));
            for (
                var n, o = new ge(r), i = [];
                !o.endOfStream() &&
                (n = this._decoder.handler(o, o.read())) !== me;
            ...
            if (!this._streaming) {
                do {
                    if ((n = this._decoder.handler(o, o.read())) === me) break;
                    null !== n &&
                        (Array.isArray(n) ? i.push.apply(i, n) : i.push(n));
                } while (!o.endOfStream());
                this._decoder = null;
        ...
        (Ee.prototype = {
            encode: function (t, e) {
                (t = t ? String(t) : ""),
                    (e = ve(e)),
                    this._streaming || (this._encoder = new je(this._options)),
                    (this._streaming = Boolean(e.stream));
                for (
                    var r,
                        n = [],
                    ...
                    !o.endOfStream() &&
                    (r = this._encoder.handler(o, o.read())) !== me;

                )
                    Array.isArray(r) ? n.push.apply(n, r) : n.push(r);
                if (!this._streaming) {
                    for (; (r = this._encoder.handler(o, o.read())) !== me; )
                        Array.isArray(r) ? n.push.apply(n, r) : n.push(r);
                    this._encoder = null;
                }
    ...
    const Ae = (t) => "function" == typeof t,
        Se = Ae(window.TextEncoder) ? window.TextEncoder : Ee,
        Fe = Ae(window.TextDecoder) ? window.TextDecoder : ke,
        xe = "AES-CBC",
        Oe = { name: xe, length: 256 },
        Te = !0,
        Pe = ["encrypt", "decrypt"],
        Re = "object" == typeof window.crypto,
        De = !Re && "object" == typeof window.msCrypto;
    let Ie;
    Re
        ? (Ie =
              null == window.crypto.subtle && null != window.crypto.webkitSubtle
                  ? window.crypto.webkitSubtle
                  : window.crypto.subtle)
        : De && (Ie = window.msCrypto.subtle);
    const Be = (t) => {
        const e = new Se().encode(t);
        return new se((t, r) => {
            if (Re) Ie.digest({ name: "SHA-256" }, e).then((e) => t(de(e)));
            else if (De) {
                const n = Ie.digest({ name: "SHA-256" }, e);
                (n.oncomplete = (e) => {
                    t(de(e.target.result));
                }),
                    (n.onerror = (t) => {
                        r(new Error("Error digesting text: " + t.type));
                    });
    ...
    var Ne = {
            generateInitVector: () => {
                if (Re && "function" == typeof window.crypto.getRandomValues)
                    return window.crypto.getRandomValues(new Uint8Array(16));
                if (De && "function" == typeof window.msCrypto.getRandomValues)
                    return window.msCrypto.getRandomValues(new Uint8Array(16));
                throw new Error("Browser not supported.");
            },
            generateAESCBCKey: () =>
                new se((t, e) => {
                    if (Re) t(Ie.generateKey(Oe, Te, Pe));
                    else if (De) {
                        const r = Ie.generateKey(Oe, Te, Pe);
                        (r.oncomplete = (e) => {
                            t(e.target.result);
                        }),
                            (r.onerror = (t) => {
                                e(new Error("Error generating key: " + t.type));
                            });
                    } else e(new Error("Browser not supported."));
                }),
            importAESCBCKeyFromRaw: (t) => {
                const e = ye(t);
                return new se((t, r) => {
                    if (Re) t(Ie.importKey("raw", e, xe, Te, Pe));
                    else if (De) {
                        const n = Ie.importKey("raw", e, xe, Te, Pe);
                        (n.oncomplete = (e) => {
                            t(e.target.result);
                        }),
                            (n.onerror = (t) => {
                                r(new Error("Error importing key: " + t.type));
                            });
                    } else r(new Error("Browser not supported."));
                });
            },
            exportAESCBCKeyToRaw: (t) =>
                new se((e, r) => {
                    if (Re) Ie.exportKey("raw", t).then((t) => e(de(t)));
                    else if (De) {
                        const n = Ie.exportKey("raw", t);
                        (n.oncomplete = (t) => {
                            e(de(t.target.result));
                        }),
                            (n.onerror = (t) => {
                                r(new Error("Error exporting key: " + t.type));
                            });
                    } else r(new Error("Browser not supported."));
                }),
            encryptSecret: (t, e, r) =>
                Be(r).then((n) => {
                    const o = new Se().encode(n + r);
                    return Re
                        ? Ie.encrypt({ name: xe, iv: t }, e, o).then((t) =>
                              de(t)
                          )
                        : De
                        ? new se((r, n) => {
                              const i = Ie.encrypt({ name: xe, iv: t }, e, o);
                              (i.oncomplete = (t) => {
                                  r(de(t.target.result));
                              }),
                                  (i.onerror = (t) => {
                                      n(
                                          new Error(
                        ...
                        : se.reject(new Error("Browser not supported."));
                }),
            decryptSecret: (t, e, r) => {
                const n = ye(r);
                return new se((r, o) => {
                    if (Re)
                        Ie.decrypt({ name: xe, iv: t }, e, n)
                            .then((t) => {
                                r(new Fe().decode(t));
                            })
                            .catch((t) => {
                        ...
                        const i = Ie.decrypt({ name: xe, iv: t }, e, n);
                        (i.oncomplete = (t) => {
                            r(new Fe().decode(t.target.result));
                        }),
                            (i.onerror = (t) => {
                                o(
                                    new Error(
                                        "Decryption failed. Message: " + t.type
                                    )
                                );
                            });
                    } else o(new Error("Browser not supported."));
                }).then((t) => {
                    const e = t.substring(0, 64),
                        r = t.substring(64);
                    if (!/^[a-f0-9]{64}$/.test(e))
                        throw new Error(
                            "Decryption failed. Unable to validate integrity."
                        );
                    return Be(r).then((t) => {
                        if (t === e) return r;
                        throw new Error(
        ...
        Je = Ke || Qe || Function("return this")();
    var Ge,
        Xe = Array.prototype,
        Ye = Function.prototype,
        Ze = Object.prototype,
        tr = Je["__core-js_shared__"],
        er = (Ge = /[^.]+$/.exec((tr && tr.keys && tr.keys.IE_PROTO) || ""))
            ? "Symbol(src)_1." + Ge
            : "",
        rr = Ye.toString,
        nr = Ze.hasOwnProperty,
        or = Ze.toString,
        ir = RegExp(
            "^" +
                rr
        ...
        cr = mr(Je, "Map"),
        lr = mr(Object, "create"),
        ur = sr ? sr.prototype : void 0,
        hr = ur ? ur.toString : void 0;
    function pr(t) {
        var e = -1,
            r = t ? t.length : 0;
        for (this.clear(); ++e < r; ) {
    ...
    (pr.prototype.clear = function () {
        ...
        (pr.prototype.get = function (t) {
            ...
            if (lr) {
                var r = e[t];
                return r === Ue ? void 0 : r;
            }
            return nr.call(e, t) ? e[t] : void 0;
        }),
        (pr.prototype.has = function (t) {
            var e = this.__data__;
            return lr ? void 0 !== e[t] : nr.call(e, t);
        }),
        (pr.prototype.set = function (t, e) {
            return (this.__data__[t] = lr && void 0 === e ? Ue : e), this;
        }),
        ...
        (fr.prototype.delete = function (t) {
            var e = this.__data__,
                r = yr(e, t);
            return (
                !(r < 0) && (r == e.length - 1 ? e.pop() : ar.call(e, r, 1), !0)
            );
        }),
    ...
    var wr = kr(function (t) {
        ...
        return (
            He.test(t) && r.push(""),
            t.replace($e, function (t, e, n, o) {
                r.push(n ? o.replace(We, "$1") : e || t);
            }),
            r
        );
    });
    ...
    function kr(t, e) {
        ...
        return (r.cache = new (kr.Cache || dr)()), r;
    }
    kr.Cache = dr;
    ...
    function jr(t) {
        return (
            ...
            ((function (t) {
                ...
                "[object Symbol]" == or.call(t))
        );
    }
    var Ar = function (t, e, r) {
            var n = null == t ? void 0 : _r(t, e);
            return void 0 === n ? r : n;
        },
        Sr = { exports: {} };
    !(function (t, e) {
        ...
        function i(t) {
            ...
            void 0 !== e &&
                e !== this.name &&
                n(this, "name", { configurable: !0, value: e, writable: !0 }),
    ...
    const Pr = (t, e, r) =>
        r.includes(t) ? t : t.includes("-") ? Pr(t.split("-")[0], e, r) : e;
    class Rr {
        constructor(t) {
            this.resourceDictionary = t;
        }
        localize(t, e) {
            let r =
                arguments.length > 2 && void 0 !== arguments[2]
                    ...
                    : { dotNotation: !1 };
            const n =
                null != r && r.dotNotation
                    ? Ar(this.resourceDictionary, t)
                    : this.resourceDictionary[t];
            if (null != n) {
                if (e) {
                    const o =
                    ...
                    let i = "",
                        ...
                        a = 0;
                    for (; s; ) {
                        s.index > a && (i += n.substring(a, s.index));
                        const c =
                            null != r && r.dotNotation ? Ar(e, s[1]) : e[s[1]];
                        if (void 0 === c)
                            throw new Tr.ArgNotFound(
                                `Arg: ${s[1]} was not defined for key: ${t}`
                            );
                        (i += c), (a = s.index + s[0].length), (s = o.exec(n));
                    }
                    return (i += n.substring(a)), i;
                }
                return n;
            }
            throw new Tr.KeyNotFound("No resource defined for key: " + t);
        }
    }
    let Dr,
        Ir,
    ...
    var Nr = (t, e, r, n) =>
                        ...
                        : (Dr ||
                              (Dr = new se((t, e) => {
                                  ...
                                  r.open(
                                      "GET",
                                      ((t, e) => {
                                          if (!t.includes("{locale}"))
                                              throw new Tr.InvalidResourceUrl(
                                      ...
                                      (r.onload = () => {
                                          try {
                                              ...
                                              return 404 === r.status
                                                  ? e(
                                                        new Tr.LocaleNotFound(
                                                            o + " not found."
                                                        )
                                                    )
                                                  : e(
                                                        new Tr.Unknown(
                                                            `Unable to load locale: ${o}, status: ${r.status}`
                                                        )
                                                    );
                                          } catch (t) {
                                              return e(
                                                  new Tr.Unknown(t.message)
                                              );
                                          }
                                      }),
                                      r.send();
        ...
        Ur = (t, e) => {
            ...
            if (!t)
                return (
                    (n = "Unable to load a localizer without a locale"),
                    se.reject(new Tr.LocaleNotSpecified(n))
                );
            if (window.localizer) return se.resolve();
            if (r.localizer) window.localizer = r.localizer;
            else {
                if (r.loadLocalizer)
                    return "function" == typeof r.loadLocalizer
                        ? se
                              .resolve(r.loadLocalizer(t))
                              .then(
                                  (t) => ((window.localizer = t), se.resolve())
                              )
                        : ((n =
                              "Specified loadLocalizer must be a function that returns a localizer or a Promise resolving to a localizer"),
                          se.reject(new Tr.LoadLocalizerNotAFunction(n)));
                if (r.localization) {
                    const {
                        defaultLocale: e,
                        supportedLocales: n,
                    ...
                    return e
                        ? n
                            ? o
                                ? Nr(t, e, n, o).then(
                                      (t) => (
                                          (window.localizer = t), se.resolve()
                                      )
                                  )
                                : se.reject(
                                      new Tr.MissingResourceUrl(
                                          "Missing resourceUrl"
                                      )
                                  )
                            : se.reject(
                                  new Tr.MissingSupportedLocales(
                                      "Missing supportedLocales"
                                  )
                              )
                        : se.reject(
                              new Tr.MissingDefaultLocale(
    ...
    const Mr = function (t, e) {
            ...
            if (
                window.localizer &&
                "function" == typeof window.localizer.localize
            )
                return window.localizer.localize(t, e, r);
            throw new Tr.LocalizerNotFound(
                "No localizer available for localization."
            );
        },
        zr = function (t) {
            let e =
            ...
            return t
                ? t.map((t) => {
                      ...
                      if (Array.isArray(t)) return Mr(t[0], t[1], e);
                      throw new Tr.UnsupportedKeyType(
        ...
        qr = function (t) {
            let e =
                arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : { dotNotation: !1 };
            const r = t.querySelectorAll("[data-i18n-id],[data-i18n-attrs]");
            for (let t = 0, n = r.length; t < n; t += 1) {
                let n = {};
                const o = r[t];
                if (o.dataset.i18nArgs)
                    try {
                        n = JSON.parse(o.dataset.i18nArgs);
                    } catch (t) {
                        throw new Tr.UnableToParseArgs(
                            "Error parsing args. Error: " + t.message
                        );
                    }
                if (
                    (o.dataset.i18nId &&
                        (o.textContent = Mr(o.dataset.i18nId, n, e)),
                    o.dataset.i18nAttrs)
                ) {
                    let t;
                    try {
                        t = JSON.parse(o.dataset.i18nAttrs);
                    } catch (t) {
                        throw new Tr.UnableToParseAttrs(
                            "Error parsing attrs. Error: " + t.message
                        );
                    }
                    t &&
                        t.placeholder &&
                        (o.placeholder = Mr(t.placeholder, n, e));
                }
            }
        };
    var Lr = (t) => {
        ...
        Yr = /^(?:0|[1-9]\d*)$/,
        Zr = "object" == typeof e && e && e.Object === Object && e,
    ...
    var rn = Array.prototype,
        ...
        pn = en.Symbol,
        fn = on.propertyIsEnumerable,
        dn = rn.splice,
        yn = An(en, "Map"),
        _n = An(Object, "create"),
        vn = pn ? pn.prototype : void 0,
        gn = vn ? vn.toString : void 0;
    function mn(t) {
        var e = -1,
            r = t ? t.length : 0;
        for (this.clear(); ++e < r; ) {
                        ...
                        return (
                            (function (t) {
                                return (
                                    ...
                                    (function (t) {
                                        return (
                                            null != t && Rn(t.length) && !Pn(t)
                                        );
                                    })(t)
                                );
                            })(t) &&
                            ln.call(t, "callee") &&
                            (!fn.call(t, "callee") || un.call(t) == Wr)
                        );
                    })(t)))
        );
    }
    (mn.prototype.clear = function () {
        ...
        (mn.prototype.has = function (t) {
            var e = this.__data__;
            return _n ? void 0 !== e[t] : ln.call(e, t);
        }),
        (mn.prototype.set = function (t, e) {
            return (this.__data__[t] = _n && void 0 === e ? Hr : e), this;
        }),
        ...
        (wn.prototype.delete = function (t) {
            var e = this.__data__,
                r = kn(e, t);
            return (
                !(r < 0) && (r == e.length - 1 ? e.pop() : dn.call(e, r, 1), !0)
            );
        }),
        ...
        (bn.prototype.set = function (t, e) {
            return jn(this, t).set(t, e), this;
        });
    var Fn = On(function (t) {
        var e;
        t =
            null == (e = t)
                ? ""
        ...
        return (
            Qr.test(t) && r.push(""),
            t.replace(Jr, function (t, e, n, o) {
                r.push(n ? o.replace(Gr, "$1") : e || t);
            }),
            r
        );
    });
    ...
    function On(t, e) {
        ...
        return (r.cache = new (On.Cache || bn)()), r;
    }
    On.Cache = bn;
    var Tn = Array.isArray;
    function Pn(t) {
        var e = Dn(t) ? un.call(t) : "";
    ...
    function Bn(t) {
        return (
            "symbol" == typeof t || (In(t) && "[object Symbol]" == un.call(t))
        );
    }
    var Nn = function (t, e) {
            return null != t && Sn(t, e, En);
        },
        Un = (t) => {
            window.console &&
                "function" == typeof console.warn &&
    ...
    var Ln = {
            callback: (t, e, r) => {
                ...
                return se
                    .try(() => {
                        switch (o) {
                            case "run":
                                if (Nn(zn, n)) return zn[n].call(null, t, i);
                                if (Nn(Mn, n))
                                    return (
                                        (zn[n] = Mn[n].fx),
                                        delete Mn[n],
                                ...
                                throw (
                                    (Un(
                                        "Attempted to run callback that does not exist or was not retained"
                                    ),
                                    t.NotHandled(
                                        "callback does not exist or was not retained"
                                    ))
                                );
                            case "retain":
                                if (Nn(Mn, n))
                                    return (zn[n] = Mn[n].fx), delete Mn[n], n;
                                throw (
                                    (Un(
                                        "Attempted to retain callback that does not exist"
                                    ),
                                    t.NotHandled(
                                        "callback can no longer be retained"
                                    ))
                                );
                            case "release":
                                return Nn(zn, n)
                                    ? (delete zn[n], null)
                                    : (Un(
                                          "Attempted to release callback that is not retained"
                                      ),
                                      null);
                            default:
                                throw (
                                    (Un("Attempted an unknown callback action"),
                                    t.NotHandled("unknown callback action"))
                                );
                        }
                    })
                    .then(r);
            ...
            serialize: (t) => {
                const e = "cb" + (qn += 1);
                return (
                    (Mn[e] = { fx: t, expires: Date.now() + 12e4 }),
                    { _callback: e }
                );
            },
            reset: () => {
    ...
    function _o(t) {
        if (
            ((r = (e = t) && e.constructor),
            (n = ("function" == typeof r && r.prototype) || co),
            e !== n)
        )
            return po(t);
        var e,
        ...
        for (var i in Object(t))
            lo.call(t, i) && "constructor" != i && o.push(i);
        return o;
    }
    function vo(t, e) {
        return (
            !!(e = null == e ? $n : e) &&
            ("number" == typeof t || ro.test(t)) &&
            t > -1 &&
            t % 1 == 0 &&
            t < e
        );
    ...
    var Po = function (t) {
            return (
                ...
                !(function (t) {
                    ...
                    var e = Oo(t);
                    if (null === e) return !0;
                    var r = So.call(e, "constructor") && e.constructor;
                    return (
                        "function" == typeof r &&
                        r instanceof r &&
                        Ao.call(r) == Fo
    ...
    var Io = function (t) {
            return (
                ...
                (!Do(t) &&
                    ...
                    "[object String]" == Ro.call(t))
            );
        },
        Bo = 9007199254740991,
        No = "[object Arguments]",
        Uo = "[object Function]",
        Mo = "[object GeneratorFunction]",
        zo = "[object Symbol]",
        qo = "object" == typeof e && e && e.Object === Object && e,
        Lo = "object" == typeof self && self && self.Object === Object && self,
        Ho = qo || Lo || Function("return this")();
    function $o(t, e, r) {
        switch (r.length) {
            case 0:
                return t.call(e);
    ...
    var Vo = Object.prototype,
        ...
        Qo = Vo.toString,
        Jo = Ho.Symbol,
        Go = Vo.propertyIsEnumerable,
        Xo = Jo ? Jo.isConcatSpreadable : void 0,
        Yo = Math.max;
    ...
    function ei(t) {
        if (
            "string" == typeof t ||
            (function (t) {
                return "symbol" == typeof t || (ni(t) && Qo.call(t) == zo);
            })(t)
        )
            return t;
        var e = t + "";
            ...
            case "object":
                return Array.isArray(t)
                    ...
                    : (Object.keys(t).forEach((e) => {
                      ...
                      r);
            case "function":
                return Ln.serialize(t);
            default:
                return t;
        }
    };
    var si = (t) => /^[a-f0-9]{24}$/.test(t),
        ai = (t) => /^[a-zA-Z0-9]{8}$/.test(t),
        ci = (t) => -1 !== ["shared", "private"].indexOf(t),
        li = (t) =>
            -1 !== ["board", "card", "member", "organization"].indexOf(t);
    const ui = { board: 8192, card: 4096, member: 4096, organization: 8192 },
        hi = {};
    function pi(t, e, r, n) {
        const o = this,
            i = { ...r };
        o.setRequestQueue || (o.setRequestQueue = new Map());
        const s = `PUT:${t}:${e}`,
            { chain: a, size: c } = o.setRequestQueue.has(s)
                ? o.setRequestQueue.get(s)
                : { chain: se.resolve(), size: 0 },
            l = () => o.get(t, e),
            u = a.then(l, l).then((t) => {
                const e = t || {},
                    r = JSON.stringify(e),
                    a = n(e);
                if (((i.data = JSON.stringify(a)), i.data === r))
                    return se.resolve();
                if (i.data.length > ui[i.scope])
                    throw new Error(
                        `PluginData length of ${
                            ui[i.scope]
                        } characters exceeded. See: https://developers.trello.com/v1.0/reference#section-size-limit`
                    );
                const c = o.requestWithContext("set", i);
                return (
                    c.finally(() => {
                        const t = o.setRequestQueue.get(s);
                        1 === t.size
                            ? o.setRequestQueue.delete(s)
                            : o.setRequestQueue.set({
                                  chain: t.chain,
                                  size: t.size - 1,
                              });
                    }),
        ...
        return o.setRequestQueue.set(s, { chain: u, size: c + 1 }), u;
    }
    (hi.getContext = function () {
        return this.args[0].context;
    }),
        (hi.isMemberSignedIn = function () {
            const t = this.getContext();
            return null != t && "notLoggedIn" !== t.member && null != t.member;
        }),
        (hi.memberCanWriteToModel = function (t) {
            if (!this.isMemberSignedIn()) return !1;
            if (
                "string" != typeof t ||
                !ko(["board", "card", "organization"], t)
            )
                throw new Error(
                    "modelType must be one of: board, card, organization"
                );
            const e = this.getContext();
            return (
                null != e &&
                null != e.permissions &&
                "write" === e.permissions[t]
            );
        }),
        (hi.requestWithContext = function (t, e) {
            const r = e || {};
            return (
                (r.context =
                    "function" == typeof this.getContext
                        ? this.getContext()
                        : {}),
                this.request(t, ii(r))
            );
        ...
        (hi.get = function (t, e, r, n) {
            ...
            if (
                ((si(t) || ai(t)) &&
                    ((s.idCard = t), (t = "card"), (i = "GET:" + s.idCard)),
                !ci(e))
            )
                throw new Error("Invalid value for visibility.");
            if (!li(t)) throw new Error("Invalid value for scope.");
            return (
                o.outstandingGetRequests.has(i) ||
                    o.outstandingGetRequests.set(
                        i,
                        o.requestWithContext("data", s)
                    ),
                o.outstandingGetRequests
                    .get(i)
                    .then((s) => {
                        let a = {};
                        if (s && Nn(s, t) && Nn(s[t], e))
                            try {
                                a = JSON.parse(s[t][e]);
                            } catch (t) {}
                        return (
                            o.outstandingGetRequests.delete(i),
                            null == r
                                ? a || n
                                : null != a && Nn(a, r)
                                ? a[r]
        ...
        (hi.set = function (t, e, r, n) {
            const o = { scope: t, visibility: e };
            if (!ci(e)) throw new Error("Invalid value for visibility.");
            if (
                ((si(t) || ai(t)) && ((o.idCard = t), (o.scope = "card")),
                !li(o.scope))
            )
                throw new Error("Invalid value for scope.");
            return pi.call(this, t, e, o, (t) => {
                const e = { ...t };
                return (
                    "object" == typeof r
        ...
        (hi.remove = function (t, e, r) {
            const n = { scope: t, visibility: e };
            let o = r;
            if (
                ((si(t) || ai(t)) && ((n.idCard = t), (n.scope = "card")),
                Array.isArray(o) || (o = [r]),
                o.some((t) => "string" != typeof t))
            )
                return (
                    Un(
            ...
            if (!li(n.scope)) throw new Error("Invalid value for scope.");
            if (!ci(e)) throw new Error("Invalid value for visibility.");
            return pi.call(this, t, e, n, (t) => {
                const e = { ...t };
                return (
                    o.forEach((t) => {
                        delete e[t];
        ...
        (hi.arg = function (t, e) {
            const r = this.args[1];
            return r && "object" == typeof r && Nn(r, t) ? r[t] : e;
        }),
        (hi.signUrl = function (t, e) {
            ...
            return t.includes("#")
                ? (Un(
                      "Power-Up signing url that already has a hash. This will remove the existing hash."
                  ),
                  `${t.slice(0, t.indexOf("#"))}#${n}`)
                : `${t}#${n}`;
        }),
        (hi.navigate = function (t) {
            return t && "object" == typeof t && "string" == typeof t.url
                ? this.requestWithContext("navigate", t)
                : se.reject(
                      new Error(
                          "Invalid or missing url provided in options object"
                      )
                  );
        }),
        (hi.showCard = function (t) {
            return t && "string" == typeof t
                ? this.requestWithContext("showCard", { idCard: t })
                : se.reject(new Error("Invalid idCard provided"));
        }),
        (hi.hideCard = function () {
            return this.requestWithContext("hideCard");
        }),
        (hi.alert = function (t) {
            const e = oi(t, ["message", "duration", "display"]),
                r = e.message;
            return !Io(r) || r.length < 1 || r.length > 140
                ? se.reject(
                      new Error(
                          "Alert requires a message of 1 to 140 characters"
                      )
                  )
                : this.requestWithContext("alert", e);
        }),
        (hi.hideAlert = function () {
            return this.requestWithContext("hideAlert");
        });
    (hi.popup = function (t) {
        if (!(this.getContext().el || (t && t.mouseEvent)))
            return (
                Un(
                ...
                se.reject(
                    new Error(
                        "Context missing target element and no mouse event provided"
                    )
                )
            );
        const e = { title: t.title };
        if (t && t.mouseEvent) {
            const { mouseEvent: r } = t,
                { clientX: n, clientY: o } = r;
            if (!ue(n) || !ue(o))
                return se.reject(new Error("Invalid mouseEvent was provided"));
            {
                let t = n,
                    i = o;
                if (0 === t && 0 === i) {
                    if (!r.target || !r.target.getBoundingClientRect)
                        return se.reject(
                            new Error("Invalid mouseEvent was provided")
                        );
        ...
        try {
            if (t.url && "string" == typeof t.url)
                e.content = {
                    type: "iframe",
                    url: this.signUrl(Lr(t.url), t.args),
                    width: t.width,
                    height: t.height,
                };
            else if (t.items)
                e.content = ((t) => {
                    let e;
                    if (Array.isArray(t.items) || "function" == typeof t.items)
                        e = t.items;
                    else {
                        if ("object" != typeof t.items)
                            throw new Error(
                                "Unsupported items type for popup. Must be an array, object, or function"
                            );
                        e = Object.keys(t.items).map((e) => {
                            const r = t.items[e];
                            return "function" == typeof r
                                ? { text: e, callback: r }
                                : r && "function" == typeof r.callback
                                ? l({ text: e }, r)
                                : { text: e };
                        });
                    }
                    return { items: e, type: "list", search: t.search };
                })(t);
            else if ("confirm" === t.type)
                e.content = ((t) => {
                    if (
                        "string" != typeof t.message ||
                        "string" != typeof t.confirmText
                    )
                        throw new Error(
                            "Confirm popups must have a message and confirmText"
                        );
                    if ("function" != typeof t.onConfirm)
                        throw new Error(
                            "Confirm popup requires onConfirm function"
                        );
                    if (
                        "function" == typeof t.onCancel &&
                        "string" != typeof t.cancelText
                    )
                        throw new Error(
                            "Confirm popup requires cancelText to support onCancel function"
                        );
                    const e = {
                        type: "confirm",
                        message: t.message,
                    ...
                    return (
                        "string" == typeof t.cancelText &&
                            (e.cancelText = t.cancelText),
                        "function" == typeof t.onCancel &&
                            (e.onCancel = t.onCancel),
                        e
                    );
                })(t);
            else {
                if ("datetime" !== t.type && "date" !== t.type)
                    return se.reject(new Error("Unknown popup type requested"));
                delete e.callback,
                    (e.content = ((t) => {
                        if ("function" != typeof t.callback)
                            throw new Error(
                                "Date popups must have a callback function"
                            );
                        const e = { type: t.type, callback: t.callback };
                        if (
                            (t.date &&
                                "function" == typeof t.date.toISOString &&
                                (e.date = t.date.toISOString()),
                            t.minDate &&
                                "function" == typeof t.minDate.toISOString &&
                                (e.minDate = t.minDate.toISOString()),
                            t.maxDate &&
                                "function" == typeof t.maxDate.toISOString &&
                                (e.maxDate = t.maxDate.toISOString()),
                            e.minDate && e.maxDate && e.minDate > e.maxDate)
                        )
                            throw new Error(
                                "Date popup maxDate must come after minDate if specified"
                            );
                        return e;
                    })(t));
            }
        ...
        (hi.boardBar = function (t) {
            if (!t || !t.url || "string" != typeof t.url)
            ...
            let e;
            t.accentColor && (e = fe(t.accentColor));
            const r = {
                content: {
                    actions: t.actions || [],
                    callback: t.callback,
        ...
        (hi.updateModal = function (t) {
            if (!t) return se.resolve();
            const { accentColor: e, actions: r, fullscreen: n, title: o } = t;
            if (!(e || r || n || o)) return se.resolve();
            ...
            return (
                e && (i.content.accentColor = fe(e)),
                this.requestWithContext("update-modal", i)
            );
        }),
        (hi.hide = function () {
            return (
                Un(
                    "hide() handler has been deprecated. Please use closePopup()"
                ),
                this.requestWithContext("close-popup")
            );
        }),
        (hi.closePopup = function () {
            return this.requestWithContext("close-popup");
        }),
        (hi.back = function () {
            return this.requestWithContext("pop-popup");
        }),
        (hi.hideOverlay = function () {
            return (
                Un(
                    "hideOverlay() handler has been deprecated. Please use closeOverlay()"
                ),
                this.requestWithContext("close-overlay")
            );
        }),
        (hi.closeOverlay = function () {
            let t =
            ...
            const e = { inset: t.inset };
            return this.requestWithContext("close-overlay", e);
        }),
        (hi.hideBoardBar = function () {
            return (
                Un(
                    "hideBoardBar() handler has been deprecated. Please use closeBoardBar()"
                ),
                this.requestWithContext("close-board-bar")
            );
        }),
        (hi.closeBoardBar = function () {
            return this.requestWithContext("close-board-bar");
        }),
        (hi.closeModal = function () {
            return this.requestWithContext("close-modal");
        }),
        (hi.sizeTo = function (t) {
            let e;
            if (Io(t)) {
                ...
                if (!r)
                    return se.reject(
                        new Error(
                            "No elements matched sizeTo query selector: " + t
                        )
                    );
                ...
                if (!(ue(t) && t > 0))
                    return se.reject(
                        new Error(
                            "Invalid argument. Must be a selector, element, or positive number. Was: " +
                                t
                        )
                    );
                e = t;
            ...
            return e
                ? this.requestWithContext("resize", { height: e })
                : se.reject(
                      new Error(
                          `Unable to determine desired height for ${t} computed ${e}`
                      )
                  );
        }),
        (hi.localizeKey = Mr),
        ...
        (hi.authorize = (t, e) => {
            ...
            if ("string" == typeof t) r = t;
                ...
                if ("function" != typeof t)
                    throw (
                        (Un(
                            "authorize requires a url or function that takes a secret and returns a url"
                        ),
                        new Error("Invalid arguments passed to authorize"))
                    );
                r = t(n);
            }
            let i = () => !0;
            o.validToken &&
                "function" == typeof o.validToken &&
                (i = o.validToken);
            const s = o.width || 800,
                a = o.height || 600,
                c = [
                    ...
                    a,
                    ",left=",
                    window.screenX + Math.floor((window.outerWidth - s) / 2),
                    ",top=",
                    window.screenY + Math.floor((window.outerHeight - a) / 2),
                ].join(""),
                l = (t, e) => {
                    const r = window.open(t, "authorize", e);
                    return (
                        "function" == typeof o.windowCallback &&
                            o.windowCallback(r),
                        r
                    );
                };
        ...
        (hi.storeSecret = function (t, e) {
            if (!this.isMemberSignedIn())
                throw new Error("No active member in context.");
            const r = this.getContext().member,
                n = this;
            return Ne.sha256Digest(`${r}:${t}`).then((t) =>
                n
                    .get("member", "private", "aescbc")
                    .then(
                        (t) =>
                            t ||
                            Ne.generateAESCBCKey().then((t) =>
                                Ne.exportAESCBCKeyToRaw(t)
                            )
                    )
                    .then((r) =>
                        Ne.importAESCBCKeyFromRaw(r).then((o) => {
                            const i = Ne.generateInitVector();
                            return Ne.encryptSecret(i, o, e).then((e) => {
                                const o = `${de(i)};${e}`;
                                return (
                                    window.localStorage.setItem(t, o),
                                    n
                                        .set("member", "private", "aescbc", r)
                                        .then(() => ({ key: t, value: o }))
                                );
                            });
                        })
        ...
        (hi.loadSecret = function (t) {
            if (!this.isMemberSignedIn())
                throw new Error("No active member in context.");
            const e = this.getContext().member,
                r = this;
            return Ne.sha256Digest(`${e}:${t}`)
                .then((t) => window.localStorage.getItem(t))
                .then((t) =>
                    t
                        ? r.get("member", "private", "aescbc").then((e) =>
                              e
                                  ? Ne.importAESCBCKeyFromRaw(e).then((e) => {
                                        const r = t.substring(
                                                0,
                                                t.indexOf(";")
                                            ),
        ...
        (hi.clearSecret = function (t) {
            if (!this.isMemberSignedIn())
                throw new Error("No active member in context.");
            const e = this.getContext().member;
            return Ne.sha256Digest(`${e}:${t}`).then(
                (t) => (window.localStorage.removeItem(t), null)
            );
        }),
        (hi.notifyParent = (t, e) => {
            const r = e || {};
        ...
        (hi.confetti = function (t) {
            const e = {};
            if (t && ue(t.clientX) && ue(t.clientY) && Po(t.target)) {
                const r = t,
                    { clientX: n, clientY: o } = r;
                let i = n,
                    s = o;
                if (0 === i && 0 === s) {
                    ...
                    (i = t.left + r.target.offsetWidth / 2),
                        (s = t.top + r.target.offsetHeight / 2);
                }
                e.pos = { x: i, y: s };
            } else {
                let r;
                if (Po(t)) r = t;
                else if (Io(t) && ((r = document.querySelector(t)), !r))
                    return se.reject(
                        new Error(
                            "No elements matched confetti query selector: " + t
                        )
                    );
                if (r) {
                    const t = r.getBoundingClientRect();
                    e.pos = {
                        x: t.left + r.offsetWidth / 2,
                        y: t.top + r.offsetHeight / 2,
                    };
                }
            }
            return this.requestWithContext("confetti", e);
        });
    const fi = new Map();
    hi.jwt = function (t) {
        if (!this.isMemberSignedIn())
            return se.reject(new Error("No active member in context."));
        const e = !0 === (null == t ? void 0 : t.card);
        if (e && !this.getContext().card)
            return se.reject(new Error("No card in context"));
        let r = "";
        if ("string" == typeof (null == t ? void 0 : t.state)) {
            if (t.state.length > 2048)
                return se.reject(
                    new Error(
                        "State parameter must be a string of at most 2048 characters"
                    )
                );
            r = t.state;
        ...
        const n = [
            ...
            e ? this.getContext().card : "",
            r,
        ].join(":");
        if (fi.has(n)) return fi.get(n);
        const o = this.requestWithContext("jwt", { state: r, includeCard: e });
        return (
            o.finally(() => {
                fi.delete(n);
            }),
    ...
    var di = (t, e) => {
            ...
            return new (r.io || S)({
                ...
                helpfulStacks:
                    "boolean" != typeof r.helpfulStacks || r.helpfulStacks,
                Sentry: r.Sentry,
            });
        },
        yi = Or("restApi", [
    ...
    const _i = {
        makeWebCall: function (t) {
            let e =
                arguments.length > 1 && void 0 !== arguments[1]
                    ...
                    : [];
            if (!this.t)
                throw new yi.AuthNotReadyError(
        ...
        registerMessageHandler: function (t) {
            return new se((e, r) => {
                let n, o;
                n = setInterval(() => {
                    t &&
                        t.closed &&
                        (clearInterval(n), r(new yi.AuthDeniedError()));
                }, 500);
                const i = (n) => {
                        n.origin === window.location.origin &&
                            ...
                            (o(),
                            n.source.close(),
                            n.data ? e(n.data) : r(new yi.AuthDeniedError()));
                    },
                    s = (t) => {
                        t.key === this.tokenStorageKey &&
                            (o(),
                            this.fetchAndStoreToken().then((t) => {
                                t ? e(t) : r(new yi.AuthDeniedError());
                            }));
                    };
                (o = () => {
        ...
        fetchAndStoreToken: function () {
            const t = this.checkForToken();
            return t
                ? this.storeToken(t).then(
                      () => (
                          this.localStorage.removeItem(this.tokenStorageKey), t
                      )
                  )
                : se.resolve(null);
        },
        getToken: function () {
            return this.fetchAndStoreToken().then(
                (t) =>
                    t ||
                    this.makeWebCall("get", [
                        "member",
                        "private",
                        this.tokenStorageKey,
                    ])
        ...
        clearToken: function () {
            ...
            return this.makeWebCall("remove", [
                "member",
                "private",
                this.tokenStorageKey,
            ]);
        ...
        popupConfig: function () {
            return `width=550,height=725,left=${
                window.screenX + (window.outerWidth - 550) / 2
            },top=${window.screenY + (window.outerHeight - 725) / 2}`;
        },
        showAuthPopup: function (t) {
            let {
                expiration: e = "never",
                scope: r = "read",
                returnUrl: n = null,
            ...
            o.return_url = n || window.location.href;
            let i = this.authBase() + "/authorize?";
            return (
                (i += Object.keys(o)
                    .map((t) => `${t}=${encodeURIComponent(o[t])}`)
                    .join("&")),
                window.open(i, "authpopup", this.popupConfig())
            );
        },
        authorize: function () {
            let t =
                arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    : {};
            return new se((e, r) => {
                const n = this.showAuthPopup(t);
                this.getToken().then((t) => {
                    t && (n.close(), e(t));
                }),
                    this.registerMessageHandler(n).then(e).catch(r);
            }).then((t) => this.storeToken(t));
        },
        isAuthorized: function () {
            return this.getToken().then((t) => !!t);
        },
        checkAndStoreToken: function () {
            const t = window.location.hash.match(/token=(.+)?/);
            if (t && 2 === t.length) {
                const e = t[1] || "";
                try {
                ...
                try {
                    window.opener &&
                        window.opener.postMessage(e, window.location.origin);
                } catch (t) {}
    ...
    class vi {
        constructor(t) {
            let {
                ...
                appKey: r,
                appName: n,
                apiOrigin: o = "https://api.trello.com",
                authOrigin: i = "https://trello.com",
                localStorage: s = window.localStorage,
                tokenStorageKey: a = "trello_token",
            } = t;
            (this.appKey = r),
                (this.appName = n),
                (this.apiOrigin = o),
    ...
    class gi {
        constructor(t) {
            ...
            (this.handlers = {}),
                (this.io = null),
                (this.NotHandled = S.NotHandled),
                (this.options = e),
                e.Sentry &&
                    e.Sentry.configureScope((t) => {
                        t.setTag("powerupjs_version", "1.22.5");
                    });
            const r = this;
            Object.keys(t).forEach((e) => {
                r.handlers[e] = function () {
                    for (
                        ...
                        n[o] = arguments[o];
                    const i = this;
                    return se.try(() => t[e].apply(i, n)).then(ii);
                };
            }),
                (this.handlers.callback = function (t, e) {
                    return Ln.callback.call(this, t, e, ii);
                });
            [
                "requestWithContext",
                "getAll",
                ...
                e = di(
                    ...
                    l(this.options, {
                        hostHandlers: l(hi, {
                            getRestApi() {
                                if (!t.restApi)
                                    throw new yi.ApiNotConfiguredError(
                                ...
                                return (t.restApi.t = this), t.restApi;
                            },
                        }),
                    })
                );
            return (
                ...
                e
                    ...
                    .then(
                        (t) => (
                            (e.secret = t.secret),
                            (window.locale = t.locale || "en"),
                            this.options.Sentry &&
                                "object" == typeof t &&
                                this.options.Sentry.configureScope((e) => {
                                    e.setTag("locale", window.locale),
                                        e.setTag(
                                            "trello_version",
                                            t.version || "unknown"
                                        ),
                                        t.member && e.setUser({ id: t.member });
                                }),
                            Ur(window.locale, this.options).then(() =>
                                e.request("ready")
                            )
                        )
                    )
        ...
        init() {
            return this.options.appKey && this.options.appName
                ? ((this.restApi = new vi({
                      t: this,
                ...
                : ((this.options.appKey || this.options.appName) &&
                      Un(
    ...
    gi.prototype.NotHandled = S.NotHandled;
    let mi = null;
    var wi,
        bi = (t, e) => {
            if (!mi)
                try {
                    ...
                    Un(
                        "Power-Up unable to parse url hash, perhaps you needed a t.signUrl(url)?"
                    ),
                        (mi = {});
                }
            return Nn(mi, t) ? mi[t] : e;
        };
    class ki {
        constructor() {
            let t =
            ...
            (this.io = null),
                (this.args = [
                    {
                        context: bi("context", t.context),
                        secret: bi("secret", t.secret),
                    },
                ].concat(bi("args"))),
                (this.secret = bi("secret", t.secret)),
                (this.options = t),
                (window.locale = bi("locale", "en")),
                (this.i18nPromise = Ur(window.locale, t)),
                this.secret ||
                    (Un(
        ...
        connect() {
            ...
            this.io = di(
                t,
                l(this.options, { secret: bi("secret"), hostHandlers: hi })
            );
        }
        request(t, e) {
            return this.io.request(t, e);
        ...
        render(t) {
            if ("function" != typeof t)
                throw new TypeError(
                    "Argument passed to render must be a function"
                );
            const e = this;
            e.onMessage &&
                window.removeEventListener("message", e.onMessage, !1),
                (e.onMessage = (r) => {
                    r.source === window.parent &&
                        "render" === r.data &&
                        e.i18nPromise.then(() => {
                            t();
                        });
                }),
                window.addEventListener("message", e.onMessage, !1);
        }
        initApi() {
            this.options.appKey && this.options.appName
                ? ((this.restApi = new vi({
        ...
        initSentry() {
            if (this.options.Sentry) {
                const t = bi("context", this.options.context);
                this.options.Sentry.configureScope((e) => {
                    e.setTag("locale", bi("locale", "en")),
                        e.setTag("powerupjs_version", "1.22.5"),
                        t &&
                            "object" == typeof t &&
                            (e.setTag("trello_version", t.version || "unknown"),
                            t.member && e.setUser({ id: t.member }),
                            t.board && e.setTag("idBoard", t.board),
                            t.permissions &&
                                Object.keys(t.permissions).forEach((r) => {
                                    e.setExtra(
                                        r + "_permission",
                                        t.permissions[r]
                                    );
    ...
    ki.prototype.NotHandled = S.NotHandled;
    for (const t in hi) Nn(hi, t) && (ki.prototype[t] = hi[t]);
    ((wi = window.Element.prototype).matches =
        wi.matches ||
    ...
    class Ei {
        constructor() {
            (this.version = "1.22.5"),
                (this.CallbackCache = Ln),
                (this.PostMessageIO = S),
                (this.Promise = se),
                (this.util = {
                    colors: { getHexString: pe, namedColorStringToHex: fe },
                    convert: {
                        bytesToHexString: de,
                        hexStringToUint8Array: ye,
                    },
                    crypto: Ne,
                    initLocalizer: Ur,
                    i18n: {
                ...
                (this.restApiError = yi),
                (this.initialize = this.initialize.bind(this)),
                (this.iframe = this.iframe.bind(this));
        }
        initialize(t, e) {
            return (
                null != this.iframeConnector &&
                    Un(
                ...
                null != this.indexConnector
                    ? (Un(
                      ...
                      this.indexConnector)
                    : ((this.indexConnector = new gi(t, e)),
        ...
        iframe(t) {
            return (
                ...
                null != this.iframeConnector ||
                    ((this.iframeConnector = new ki(t)),
                    this.iframeConnector.init()),
                this.iframeConnector
            );
        }
    }
    window.TrelloPowerUp = new Ei();
});
